  ...
  return (
    <PolicyPage
      ...
      sections={[
        ...
        { heading: 'How we use it', body: 'Solely to process and deliver your order, contact you about it (email, SMS, or WhatsApp), and — if you opt in — send reorder reminders. We do not sell customer data.' },
